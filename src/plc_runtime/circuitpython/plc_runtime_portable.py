"""Portable ladder runtime that stays within CircuitPython-friendly syntax.

This module is imported by the desktop app for tests and copied onto the
board as ``plc_runtime_portable.py`` during CircuitPython runtime install.
"""
