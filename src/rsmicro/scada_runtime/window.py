...
class ScadaWindow(QMainWindow):
 def __init__(self,screen,no_write=False):
  super().__init__(); self.screen=screen; self.no_write=no_write; self.setWindowTitle(f"RSmicro SCADA — {screen.name}")
