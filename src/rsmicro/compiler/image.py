...
MAGIC=b'RSM1'; VERSION=(2,0); HEADER_FMT='<4sBBHIIHH16s32sI'; DESC_FMT='<HHIIII'; HEADER_SIZE=struct.calcsize(HEADER_FMT); DESC_SIZE=struct.calcsize(DESC_FMT)
