...
from .validation import validate_compile_project
...
def compile_project(project,controller_id,profile=PROFILE_ID,deployment_id=None,options=None):
 ...
 ds=validate_compile_project(project,c,deps[0] if deps else None)
